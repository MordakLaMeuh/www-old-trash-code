...
/* OUTDATED: Original Scrollbar, unique. */
	...
	var logScrollbar = function (ID) {
		...
		this.middleDiv.onmousedown					= 	function(e) { SUPER.moveCursor(e); return false; }
		this.middleDiv.onmousemove =  this.scroller.onmousemove = 	function(e) { if (documentEventMouseDown) SUPER.moveCursor(e); return false; }

		arrowUp.onmousedown 						=   	function(e) { SUPER.mousedown(this, -1); return false; }
		arrowDown.onmousedown 						= 	function(e) { SUPER.mousedown(this, 1); return false;  }
		arrowUp.onmouseout 	= arrowUp.onmouseup 		= 	function(e) { SUPER.clear(); return false; }
		arrowDown.onmouseout	= arrowDown.onmouseup		= 	function(e) { SUPER.clear(); return false; }
		this.newMainDiv.addEventListener(mousewheelevt, function(e) {SUPER.MouseWheelHandler(e)}, false);

		this.newMainDiv.onscroll = function(e) { SUPER.scrolling(); return false; }

		this.DisplayScrollbar();

		this.refresh();
		window.addEventListener('resize', function(){SUPER.refresh()}, false);
...
/**************************** GENERAL CONSOLE MESSAGE PROTOTYPES ********************/
	...
	logScrollbar.prototype.arrow_scroll = function () {
		if (this.scrollContinue != 0) {
			...
			this.scrollingTimeout = setTimeout(function(){SUPER.arrow_scroll()}, this.scrollInverseSpeed);
...
/*** Forme plus simple de scrollbar sans les deux boutons mais plus fûtée aussi. ***/
	var contextScrollbar = function (ID,ratioHeight,ratiowidth) {
		...
		this.scrollDiv.onmousedown					= 	function(e) { SUPER.moveCursor(e); return false; }
		this.scrollDiv.onmousemove =  this.scroller.onmousemove = 	function(e) { if (documentEventMouseDown)SUPER.moveCursor(e); return false; }
...
/* Gestion des messages de la pachy box. ATTENTION utilise div chatTab */
	...
	this.sendMsg = (function () {
		...
		return function() {
			...
			if (message) {
				if(_RTC_CORE_.sendMsgToAll(JSON.stringify({
					rtcDataType: 'CHAT',
					msg 		: message
							})))		this.console.alert("_RTC_CORE_ response -> critical warning. You're just talking to the wind.")
