...
//
// Client:
// HELO -> Indique au serveur que le client est prêt./ Le serveur lui renvoit une liste des ordinateurs connectés après avoir généré un ID 'unique" pour le client.
...
//
// Server:
// HELO -> Message renvoyé par le serveur contenant la liste des ordinateurs connectés.
// 'other' -> Messages retransmis venant des autres clients.
//
// VARIABLE UTILISES POUR LA TRANSMISSION:
// clientlist[] -> Liste des IDs uniques de chaque client.
