...
MW.prototype.set_Property = function(title_Window,positionX,positionY,sizeX,sizeY,border_Color,body_Color)
{
	...
	//var Z = this.hide_Header.offsetHeight/window.innerWidth*100*(window.innerWidth/window.innerHeight);	//this.hide_Header.offsetHeight*100/window.innerHeight; // TODO smartphone patch
	//this.hide_Header.style.width 	= this.opacity_Button.style.width = this.close.style.width = this.maximize.style.width = this.minimize.style.width = this.put_Backward.style.width = Z+'vh';
}
